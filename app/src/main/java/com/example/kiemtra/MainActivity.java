...
import com.example.kiemtra.adapter.SwipeItem;
...
public class MainActivity extends AppCompatActivity implements ProductAdapter.OnDeleteClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<SanPham> listProduct = productDAO.GetAll();
    ...
    private void showAddProductDialog() {
        ...
        btnSaveProduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SanPham p = new SanPham(txtName.getText().toString(), Float.parseFloat(txtPrice.getText().toString()), txtImage.getText().toString());
                productDAO.add(p);
                refreshProductList();
